...
Dieser dritte Punkt gehört offen angesprochen: Der Website Standard wurde von einem
...
Der Website Standard kennzeichnet deshalb bei **jedem einzelnen Kriterium**, woher der
Wert stammt:
...
der Website Standard vor der Bewertung eine **Branchenklasse**.
...
**Ergebnis: 76 Punkte — Website Standard Silber.**
...
> **Ergebnis: 50 Punkte — Website Standard Bronze (rechnerisch 76).**
