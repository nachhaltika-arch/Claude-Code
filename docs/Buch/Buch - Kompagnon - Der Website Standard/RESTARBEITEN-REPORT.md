# RESTARBEITEN-REPORT — Buch „Der Website Standard"
...
| D3 | Tabellen in 11.4–11.6, 12.2 und Anhang B **beim Build aus `website-standard.json` erzeugen** statt pflegen — vier Stellen mit denselben Zahlen | 11, 12, Anhang B |
