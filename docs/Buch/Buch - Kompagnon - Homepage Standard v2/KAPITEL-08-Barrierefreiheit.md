...
|---|---|---|---|
| B1 | Gesamtwert der Barrierefreiheitsprüfung | 3 | alle Klassen |
| B2 | Farbkontraste | 2 | alle Klassen |
| B3 | Alternativtexte für Bilder | 2 | alle Klassen |
| B4 | Semantik und Struktur | 2 | alle Klassen |
| B5 | Tastaturbedienung | 1 | alle Klassen |
