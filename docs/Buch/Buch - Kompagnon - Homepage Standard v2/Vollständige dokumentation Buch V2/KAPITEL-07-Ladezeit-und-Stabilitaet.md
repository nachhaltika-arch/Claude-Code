...
**Erstens: Wenn die Messung ausfällt, fallen zwölf Punkte aus.** Nicht auf null — sie fallen aus der Rechnung, wie in Abschnitt 3.5 beschrieben. Ihr anwendbares Maximum sinkt dann von 103 auf 91. Zusammen mit drei Kriterien in Kapitel 8, die aus derselben Quelle stammen (B1, B2 und B5, zusammen 6 Punkte), können auf diese Weise **bis zu 18 von 103 Punkten** unerhoben bleiben.

::: MRG
**Wenn die Messung ausfällt**
P1–P4 (12 P) und B1, B2, B5 in Kapitel 8 (6 P) sind nicht erhebbar.
