...
**3a — Abschnitt 2, Tabelle „Der Website Standard existiert bereits an drei Stellen im Code":**
...
| `frontend/src/utils/websiteStandard.js` | Stufenschwellen fürs Frontend — folgt dem Backend |
