...
```bash
ls docs/Buch/"Buch - Kompagnon - Der Website Standard"/*.md | grep -v RESTARB | wc -l   # 15
wc -w docs/Buch/"Buch - Kompagnon - Der Website Standard"/{0,1,9}*.md | tail -1          # 43.810
```
...
```bash
grep -rn -B3 -A3 "Kapitel 14" docs/Buch/"Buch - Kompagnon - Der Website Standard"/*.md
```
...
```bash
ls docs/Buch/"Buch - Kompagnon - Der Website Standard"/*.md | grep -v RESTARB
grep -rn "Kapitel 14" docs/Buch/"Buch - Kompagnon - Der Website Standard"/*.md | wc -l
```
