...
```bash
grep -rn "E6\|sechs Kriterien\|Sechs Kriterien" docs/Buch/"Buch - Kompagnon - Der Website Standard"/*.md
grep -rn "Kapitel 7" docs/Buch/"Buch - Kompagnon - Der Website Standard"/*.md
```
