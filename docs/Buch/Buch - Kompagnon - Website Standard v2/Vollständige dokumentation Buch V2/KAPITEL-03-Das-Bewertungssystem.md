...
Der Website Standard bewertet Ihre Website **von außen**. Genau so, wie ein Kunde, ein Bewerber oder ein Wettbewerber sie sieht. Es wird kein Zugang zu Ihrem System benötigt, kein Passwort, keine Erlaubnis. Das hat einen Vorteil und einen Preis.
...
|---|---|---|
| **Website Standard Platin** | 95–100 | Vollständige Erfüllung einschließlich der Kriterien, die über die Pflicht hinausgehen. Selten |
| **Website Standard Gold** | 85–94 | Alle Pflichtanforderungen erfüllt, dazu erkennbare Qualitätsmerkmale. Das empfohlene Zielniveau |
| **Website Standard Silber** | 70–84 | Solide Grundlage. Rechtlich weitgehend in Ordnung, technisch und inhaltlich mit Lücken |
| **Website Standard Bronze** | 50–69 | Mindestanforderungen teilweise erfüllt, erhebliche Lücken |
...
`76 ÷ 103 × 100 = 73,8` → gerundet **74 Punkte** → **Website Standard Silber**
...
`88 ÷ 103 × 100 = 85,4` → gerundet **85 Punkte** → **Website Standard Gold**
