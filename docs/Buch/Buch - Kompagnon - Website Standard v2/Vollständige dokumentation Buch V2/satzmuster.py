#!/usr/bin/env python3
"""Satzmuster „Der Website Standard" — 170 x 240 mm.
...
c = canvas.Canvas("Satzmuster-Website-Standard.pdf", pagesize=(PB, PH))
c.setTitle("Der Website Standard — Satzmuster")
...
c.setFont("Haus-B", 34)
c.drawString(BUND, PH - 58 * mm, "WEBSITE")
...
c.setFont("Haus-B", 27)
c.drawString(X_HAUPT, y - 14 * mm, "WEBSITE")
...
c.setFillColor(black)
c.drawString(X_HAUPT, y, "DER WEBSITE STANDARD")
y -= RASTER
...
stufen = [(4, "Website Standard Platin", "95–100"),
          (3, "Website Standard Gold", "85–94"),
          (2, "Website Standard Silber", "70–84"),
          (1, "Website Standard Bronze", "50–69"),
...
c.save()
print("Satzmuster-Website-Standard.pdf geschrieben — 12 Seiten")
