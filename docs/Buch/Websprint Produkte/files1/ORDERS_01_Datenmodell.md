...
> **Korrigiert am 2026-08-27.** Hier stand `staging`.
> Dieser Branch ist am 01.05.2026 mit dem Wechsel auf `staging → main`
> verworfen worden (`CLAUDE.md`); `tests/test_toter_branch.py` faengt genau
> solche Anweisungen ab. Wer der alten Zeile folgt, legt den toten Branch
> neu an — und pusht an der CI und am Deploy vorbei.
