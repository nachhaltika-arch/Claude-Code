...
| L-09 | Testabdeckung — **Fundament gelegt 2026-08-07, erweitert 2026-08-08**: 39 Backend- + 15 Frontend-Unit- + 11 Browser-Tests, alle als Pflicht-Checks. Weiterhin offen: Wireframe, Style-Guide-Freigabe, Design-View, Zahlungen | M | `backend/tests/`, `frontend/src/utils/*.test.js`, `e2e/` |
