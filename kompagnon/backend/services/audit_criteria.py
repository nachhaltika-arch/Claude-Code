        ...
        criteria=(
            ...
            Criterion("rc_cookie", "Cookie-Consent (TDDDG)", 4, Source.MEASURED,
                      ...
                      abstufung=Abstufung("JA_NEIN", "ab", (
                          Stufe(4, None, "Ein Consent-Werkzeug ist erkannt — oder es ist kein einwilligungspflichtiger Dienst eingebunden"),
                          Stufe(0, None, "Einwilligungspflichtige Dienste ohne erkanntes Consent-Werkzeug"),
                      ))),
    ...
    Category(
        ...
        criteria=(
            Criterion("si_ssl", "TLS-Zertifikat gültig", 3, Source.MEASURED,
                      ...
                      abstufung=Abstufung("SCHWELLE", "ab", (
                          Stufe(3, None, "Das Zertifikat ist gültig und läuft nicht in Kürze ab"),
                          Stufe(2, None, "Das Zertifikat ist gültig, läuft aber in Kürze ab"),
...
P5 und wird gemessen.""",
            ...
            Criterion("dg_mobil", "Mobile Darstellung", 1, Source.MEASURED,
                      ...
                      abstufung=Abstufung("JA_NEIN", "ab", (
                          Stufe(1, None, "Eine Viewport-Angabe steht im Kopf der Seite"),
                          Stufe(0, None, "Es steht keine Viewport-Angabe im Kopf der Seite"),
                      ))),
        ),
    ),
    Category(
...
das Angebot inhaltlich klar ist (C5).""",
            ...
            Criterion("cv_cta", "Primär-CTA", 3, Source.DERIVED,
                      ...
                      abstufung=Abstufung("SCHWELLE", "ab", (
                          Stufe(3, 3, "Drei oder mehr Handlungsaufrufe, die in dieser Branchenklasse zählen"),
                          Stufe(2, 1, "Ein oder zwei solche Handlungsaufrufe"),
                          Stufe(0, None, "Kein Handlungsaufruf"),
                      ))),
