...
// Die oeffentliche Preisuebersicht auf der Startseite.
//
// Bis zum 23.08.2026 standen hier Starter/KOMPAGNON/Premium mit
// WordPress-Merkmalen. Beides ist ueberholt: Der Katalog fuehrt seit dem
// Websprint-Wechsel andere Produkte (L-97), und gebaut wird im
// KOMPAGNON-Komponentensystem, nicht in WordPress — eine Werbeaussage ueber
// eine Technik, die nicht zum Einsatz kommt, ist wettbewerbsrechtlich
// angreifbar.
//
// Preise und Namen kommen aus `products` (L-29); hier steht nur, wie sie
// aussehen. Merkmale und Bauzeiten stammen aus den Leistungsverzeichnissen
// in docs/produkte/.
const DARSTELLUNG = [
  {
    id: 'websprint_relaunch',
    badge: 'Einstieg',
    badgeColor: 'var(--kc-mid)',
    badgeBg: 'var(--kc-mid-a-12)',
    name: 'Websprint Relaunch',
    tagline: 'Ihre Seite trägt — sie muss nur wieder tragen können.',
    delivery: '14 Kalendertage',
    accentColor: 'var(--kc-mid)',
    ctaBg: 'var(--kc-mid)',
    ctaLabel: 'Relaunch wählen',
    features: [
      'Eingangsaudit nach Homepage-Standard, 100 Punkte',
      'Aufbau im Komponentensystem, bis 6 Seiten',
      'Redaktionelle Überarbeitung Ihrer Texte',
      'Bildaufbereitung, bis 30 Bilder',
      'Technische Grundoptimierung',
      'Hosting, SSL, Domainumstellung',
      'Abnahmeaudit mit schriftlichem Protokoll',
    ],
    missing: [
      'Positionierungsgespräch',
  ...
  },
  {
    ...
    name: 'Websprint Neubau',
    tagline: 'Neu aufgebaut — vom Warum her, nicht vom Design.',
    delivery: '28 Kalendertage',
    accentColor: '#d4a017',
    ctaBg: '#d4a017',
    ctaLabel: 'Neubau wählen',
    recommended: true,
    features: [
      'Positionierungsgespräch, 90 Minuten',
      'Bauplan als Freigabedokument',
      ...
      'Abnahmeaudit mit Protokoll',
      'Pflege Basic für 3 Monate',
  ...
  },
  {
    ...
    name: 'Websprint System',
    tagline: 'Sichtbar für Menschen — und für die Maschinen, die sie fragen.',
    delivery: '42 Kalendertage',
    accentColor: '#7c3aed',
    ctaBg: '#7c3aed',
    ctaLabel: 'System anfragen',
    features: [
      'Alles aus dem Websprint Neubau',
      'Erweiterter Seitenumfang, bis 20 Seiten',
      'Karriereseite mit Bewerbungsformular',
      'GEO/GAIO: llms.txt, schema.org, Ground Page',
      'Messgrundlage mit Consent-Layer',
      'Auftragsverarbeitungsvertrag',
      'Pflege Pro für 12 Monate',
      'Quartalsweises Re-Audit',
    ],
  },
];
...
const COMPARE_ROWS = [
  ...
  { label: 'Bildaufbereitung', values: ['bis 30', 'bis 60', 'bis 60'] },
  { label: 'Korrekturschleifen', values: ['1', '2', '2'] },
  { label: 'Karriereseite', values: ['–', '–', '✓'] },
  { label: 'GEO / KI-Auslieferung', values: ['–', '–', '✓'] },
  { label: 'Messgrundlage + Consent', values: ['–', '–', '✓'] },
  { label: 'Grundlagen Barrierefreiheit', values: ['✓', '✓', '✓'] },
