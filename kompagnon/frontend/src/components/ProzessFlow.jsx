...
const PHASEN = [
  {
    ...
    schritte: [
      ...
      { id: 'analyse-zentrale', nr: 3, label: 'Analyse-Zentrale', desc: 'Crawler, PageSpeed, Hosting, GA', icon: '🔬', component: 'AnalyseZentrale',
      ...
      { id: 'assets', nr: 8, label: 'Assets klären', desc: 'Logo, Fotos und CI-Materialien — werden automatisch erkannt.', icon: '📦', component: 'AssetsKlaeren', optional: true,
      ...
      { id: 'funktionen', nr: 9, label: 'Funktionen', desc: 'Terminbuchung, Shop, Mehrsprachigkeit — automatisch erkannt.', icon: '⚙️', component: 'Funktionen', optional: true,
      ...
      { id: 'seo-ziele', nr: 10, label: 'SEO-Ziele', desc: 'Keywords automatisch generiert — Google Business und Social Media aus Website erkannt.', icon: '📈', component: 'SeoZiele', optional: true,
  ...
  },
  {
    ...
    schritte: [
      { id: 'ki-report', nr: 11, label: 'KI-Report erstellen', desc: 'KI-Analyse aus Briefing + Crawler-Daten', icon: '🤖', component: 'KiReport',
  ...
  },
  {
    ...
    schritte: [
      { id: 'moodboard', nr: 12, label: 'Moodboard / Stilrichtung', desc: 'Stilrichtung und Farbwelt festlegen', icon: '🎨', component: 'Moodboard',
        istFertig: (d) => !!(d.moodboardDone),
        wasFehlts: () => ['Stilrichtung noch nicht gewaehlt'],
        fertigText: () => 'Stilrichtung festgelegt', optional: true },
      { id: 'sitemap', nr: 13, label: 'Sitemap anlegen', desc: 'Seitenstruktur definieren', icon: '🗺️', component: 'Sitemap',
      ...
      { id: 'seiteninhalte', nr: 14, label: 'Seiteninhalte', desc: 'KI-Texte je Seite erstellen', icon: '📄', component: 'ContentSeiteninhalte',
      ...
      { id: 'build-assets', nr: 15, label: 'Bilder & Assets', desc: 'Bilder und Medien je Seite zuordnen', icon: '🖼️', component: 'ContentAssets',
        istFertig: (d) => !!(d.hasAssets),
        wasFehlts: () => ['Noch keine Bilder zugeordnet'],
        fertigText: () => 'Assets zugeordnet', optional: true },
      { id: 'content-freigabe', nr: 16, label: 'Freigabe', desc: 'Kundenfreigabe für Seiteninhalte', icon: '✅', component: 'ContentFreigabe',
  ...
  },
  {
    ...
    schritte: [
      { id: 'design-generieren', nr: 17, label: 'Design generieren', desc: 'Template + KI-Entwurf', icon: '✨', component: 'DesignStudio',
      ...
      { id: 'editor', nr: 18, label: 'Editor nachbearbeiten', desc: 'Feinschliff im GrapesJS', icon: '🖊️', component: 'Editor', optional: true,
  ...
  },
  {
    ...
    schritte: [
      { id: 'netlify', nr: 19, label: 'Netlify deployen', desc: 'Website veroeffentlichen', icon: '🚀', component: 'Netlify',
      ...
      { id: 'dns', nr: 20, label: 'DNS umstellen', desc: 'CNAME beim Domain-Anbieter', icon: '🌍', component: 'DNS',
      ...
      { id: 'qa', nr: 21, label: 'QA-Check', desc: 'Links, Mobile, Impressum', icon: '✓', component: 'QA',
        istFertig: (d) => !!(d.qaResult),
        wasFehlts: () => ['QA-Scan nicht durchgefuehrt'],
        fertigText: () => 'QA abgeschlossen' },
      { id: 'abnahme', nr: 22, label: 'Abnahme & Go Live', desc: 'Kundenfreigabe', icon: '🏁', component: 'Abnahme',
  ...
  },
  {
    ...
    schritte: [
      { id: 'qm-checkliste', nr: 23, label: 'QM-Checkliste', desc: 'Qualitaetssicherung nach Go Live', icon: '✅', component: 'QmCheckliste',
        istFertig: (d) => !!(d.qmDone),
        wasFehlts: () => ['Checkliste noch nicht abgehakt'],
        fertigText: () => 'QM abgeschlossen', optional: true },
      { id: 'ki-qa-scan', nr: 24, label: 'KI-QA-Scan', desc: 'Automatische Qualitaetspruefung per KI', icon: '🤖', component: 'KiQaScan',
        istFertig: (d) => !!(d.qaResult),
  ...
  },
  {
    ...
    schritte: [
      { id: 'gbp-qr', nr: 25, label: 'GBP + QR-Code', desc: 'Google Business Profile & Bewertungs-QR', icon: '📍', component: 'GbpQr',
        istFertig: (d) => !!(d.gbpPlaceId),
        wasFehlts: () => ['GBP-Place-ID fehlt'],
        fertigText: () => 'GBP eingerichtet', optional: true },
      { id: 'trustpilot', nr: 26, label: 'Trustpilot', desc: 'Bewertungsanfrage an Kunden senden', icon: '⭐', component: 'Trustpilot',
        istFertig: () => false,
        wasFehlts: () => [],
        fertigText: () => 'Anfrage gesendet', optional: true },
      { id: 'website-vergleich', nr: 27, label: 'Website-Vergleich', desc: 'Vorher / Nachher Screenshots', icon: '📸', component: 'WebsiteVergleich',
  ...
  },
  {
    ...
    schritte: [
      { id: 'upsell', nr: 28, label: 'Up-Sales', desc: 'Retainer, SEO, Wartungspaket anbieten', icon: '💼', component: 'Upsell',
        istFertig: () => false,
        wasFehlts: () => [],
        fertigText: () => 'Angebot erstellt', optional: true },
      { id: 'live-daten', nr: 29, label: 'Live-Daten', desc: 'PageSpeed, Domain-Status, Projektabschluss', icon: '🌐', component: 'LiveDaten',
