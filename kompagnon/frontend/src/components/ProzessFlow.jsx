...
const PHASEN = [
  {
    ...
    schritte: [
      ...
      { id: 'seo-ziele', nr: 5, label: 'SEO-Ziele', desc: 'Keywords, Google Business, Social Media', icon: '📈', component: 'SeoZiele',
        ...
        wasFehlts: () => ['SEO-Ziele noch nicht gesetzt'],
        fertigText: () => 'SEO-Ziele gesetzt' },
      { id: 'audit', nr: 6, label: 'Website-Audit', desc: 'Technische Analyse der bestehenden Website', icon: '🔍', component: 'Audit',
      ...
      { id: 'analyse-zentrale', nr: 7, label: 'Analyse-Zentrale', desc: 'Crawler, PageSpeed, GA, Hosting', icon: '🔬', component: 'AnalyseZentrale',
      ...
      { id: 'brand-design', nr: 8, label: 'Brand Design', desc: 'Farben, Schriften und Stil festlegen', icon: '🎨', component: 'BrandDesign',
      ...
      { id: 'brand-guideline', nr: 9, label: 'Brand Guideline', desc: 'KI erstellt Design-Token-System', icon: '📐', component: 'BrandGuideline',
        istFertig: (d) => !!(d.brandGuidelineGenerated),
        wasFehlts: () => ['Brand Guideline noch nicht generiert'],
        fertigText: () => 'Design-System erstellt' },
      { id: 'seo-analyse', nr: 10, label: 'SEO-Analyse', desc: 'Lokale SEO-Positionierung analysieren', icon: '📊', component: 'SeoAnalyse',
      ...
      { id: 'briefing-website', nr: 11, label: 'Briefing Website', desc: 'Ziele, Design, Seiten dokumentieren', icon: '📋', component: 'BriefingWebsite',
        ...
        fertigText: () => 'Ausgefuellt' },
      { id: 'zugangsdaten', nr: 12, label: 'Zugangsdaten', desc: 'Hosting, FTP, CMS-Zugaenge', icon: '🔑', component: 'Zugangsdaten', optional: true,
  ...
  },
  {
    ...
    schritte: [
      ...
      { id: 'seiteninhalte', nr: 14, label: 'Seiteninhalte', desc: 'KI schreibt alle Texte auf einmal', icon: '📝', component: 'Seiteninhalte',
      ...
      { id: 'bilder-assets', nr: 15, label: 'Bilder & Assets', desc: 'Fotos, Icons und Medien zuweisen', icon: '🖼️', component: 'BilderAssets', optional: true,
        istFertig: (d) => !!(d.assetsChecked),
        wasFehlts: () => ['Bilder noch nicht geprueft'],
        fertigText: () => 'Geprueft' },
      { id: 'freigaben', nr: 16, label: 'Freigaben', desc: 'Content-Freigabe vom Kunden', icon: '✅', component: 'Freigaben', optional: true,
  ...
  },
  {
    ...
    schritte: [
      ...
      { id: 'qa', nr: 21, label: 'QM-Audit', desc: 'Qualitaetskontrolle der neuen Website', icon: '✅', component: 'QA',
        istFertig: (d) => !!(d.qaResult),
        wasFehlts: () => ['QM-Audit nicht durchgefuehrt'],
