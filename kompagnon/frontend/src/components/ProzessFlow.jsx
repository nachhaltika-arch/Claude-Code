...
const PHASEN = [
  {
    ...
    schritte: [
      ...
      { id: 'ziele-zielgruppe', nr: 2, label: 'Ziele & Zielgruppe', desc: 'KI leitet Ziele und Zielgruppe automatisch ab — bitte prüfen.', icon: '🎯', component: 'ZieleZielgruppe', optional: true,
        istFertig: (d) => !!(d.briefing?.hauptziel && d.briefing?.aktionen),
        wasFehlts: () => ['Ziele noch nicht ausgefüllt'],
        fertigText: () => 'Ausgefüllt' },
      { id: 'audit', nr: 3, label: 'Website-Audit', desc: 'Technische Analyse der bestehenden Website', icon: '🔍', component: 'Audit',
      ...
      { id: 'analyse-zentrale', nr: 4, label: 'Analyse-Zentrale', desc: 'Crawler, PageSpeed, Hosting, GA', icon: '🔬', component: 'AnalyseZentrale',
      ...
      { id: 'brand-design', nr: 5, label: 'Brand Design', desc: 'Farben, Schriften und Stil festlegen', icon: '🎨', component: 'BrandDesign',
        istFertig: (d) => !!(d.brandPrimaryColor),
        wasFehlts: () => ['Brand Design noch nicht gespeichert'],
        fertigText: (d) => d.brandPrimaryColor || 'Gespeichert' },
      { id: 'brand-guideline', nr: 6, label: 'Brand Guideline', desc: 'KI-generierte Guideline mit Farb-Tokens', icon: '📐', component: 'BrandGuideline', optional: true,
      ...
      { id: 'assets', nr: 9, label: 'Assets klären', desc: 'Logo, Fotos und CI-Materialien — werden automatisch erkannt.', icon: '📦', component: 'AssetsKlaeren', optional: true,
        istFertig: (d) => !!(d.briefing?.logo_vorhanden !== undefined && d.assetsGeklaert),
  ...
  },
  {
    ...
    schritte: [
      { id: 'ki-report', nr: 12, label: 'KI-Report erstellen', desc: 'KI-Analyse aus Briefing + Crawler-Daten', icon: '🤖', component: 'KiReport',
  ...
  },
  {
    ...
    schritte: [
      { id: 'moodboard', nr: 13, label: 'Moodboard / Stilrichtung', desc: 'Stilrichtung und Farbwelt festlegen', icon: '🎨', component: 'Moodboard',
        istFertig: (d) => !!(d.moodboardDone),
        wasFehlts: () => ['Stilrichtung noch nicht gewaehlt'],
        fertigText: () => 'Stilrichtung festgelegt', optional: true },
      { id: 'sitemap', nr: 14, label: 'Sitemap anlegen', desc: 'Seitenstruktur definieren', icon: '🗺️', component: 'Sitemap',
      ...
      { id: 'seiteninhalte', nr: 15, label: 'Seiteninhalte', desc: 'KI-Texte je Seite erstellen', icon: '📄', component: 'ContentSeiteninhalte',
      ...
      { id: 'build-assets', nr: 16, label: 'Bilder & Assets', desc: 'Bilder und Medien je Seite zuordnen', icon: '🖼️', component: 'ContentAssets',
        istFertig: (d) => !!(d.hasAssets),
        wasFehlts: () => ['Noch keine Bilder zugeordnet'],
        fertigText: () => 'Assets zugeordnet', optional: true },
      { id: 'content-freigabe', nr: 17, label: 'Freigabe', desc: 'Kundenfreigabe für Seiteninhalte', icon: '✅', component: 'ContentFreigabe',
  ...
  },
  {
    ...
    schritte: [
      { id: 'design-generieren', nr: 18, label: 'Design generieren', desc: 'Template + KI-Entwurf', icon: '✨', component: 'DesignStudio',
      ...
      { id: 'editor', nr: 19, label: 'Editor nachbearbeiten', desc: 'Feinschliff im GrapesJS', icon: '🖊️', component: 'Editor', optional: true,
  ...
  },
  {
    ...
    schritte: [
      { id: 'netlify', nr: 20, label: 'Netlify deployen', desc: 'Website veroeffentlichen', icon: '🚀', component: 'Netlify',
      ...
      { id: 'dns', nr: 21, label: 'DNS umstellen', desc: 'CNAME beim Domain-Anbieter', icon: '🌍', component: 'DNS',
      ...
      { id: 'qa', nr: 22, label: 'QM-Audit', desc: 'Qualitätskontrolle der neuen Website — gleicher Audit, neue Seite.', icon: '✅', component: 'QA',
        istFertig: (d) => !!(d.qaResult),
        wasFehlts: () => ['QM-Audit noch nicht durchgeführt'],
        fertigText: () => 'QM abgeschlossen' },
      { id: 'abnahme', nr: 23, label: 'Abnahme & Go Live', desc: 'Kundenfreigabe', icon: '🏁', component: 'Abnahme',
  ...
  },
  {
    ...
    schritte: [
      { id: 'qm-checkliste', nr: 24, label: 'QM-Checkliste', desc: 'Qualitaetssicherung nach Go Live', icon: '✅', component: 'QmCheckliste',
        istFertig: (d) => !!(d.qmDone),
        wasFehlts: () => ['Checkliste noch nicht abgehakt'],
        fertigText: () => 'QM abgeschlossen', optional: true },
      { id: 'ki-qa-scan', nr: 25, label: 'KI-QA-Scan', desc: 'Automatische Qualitaetspruefung per KI', icon: '🤖', component: 'KiQaScan',
        istFertig: (d) => !!(d.qaResult),
  ...
  },
  {
    ...
    schritte: [
      { id: 'gbp-qr', nr: 26, label: 'GBP + QR-Code', desc: 'Google Business Profile & Bewertungs-QR', icon: '📍', component: 'GbpQr',
        istFertig: (d) => !!(d.gbpPlaceId),
        wasFehlts: () => ['GBP-Place-ID fehlt'],
        fertigText: () => 'GBP eingerichtet', optional: true },
      { id: 'trustpilot', nr: 27, label: 'Trustpilot', desc: 'Bewertungsanfrage an Kunden senden', icon: '⭐', component: 'Trustpilot',
        istFertig: () => false,
        wasFehlts: () => [],
        fertigText: () => 'Anfrage gesendet', optional: true },
      { id: 'website-vergleich', nr: 28, label: 'Website-Vergleich', desc: 'Vorher / Nachher Screenshots', icon: '📸', component: 'WebsiteVergleich',
  ...
  },
  {
    ...
    schritte: [
      { id: 'upsell', nr: 29, label: 'Up-Sales', desc: 'Retainer, SEO, Wartungspaket anbieten', icon: '💼', component: 'Upsell',
        istFertig: () => false,
        wasFehlts: () => [],
        fertigText: () => 'Angebot erstellt', optional: true },
      { id: 'live-daten', nr: 30, label: 'Live-Daten', desc: 'PageSpeed, Domain-Status, Projektabschluss', icon: '🌐', component: 'LiveDaten',
