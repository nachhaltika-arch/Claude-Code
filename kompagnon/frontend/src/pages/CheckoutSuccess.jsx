  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f2f8', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ background: '#fff', borderRadius: 20, padding: 48, maxWidth: 520, width: '100%', textAlign: 'center', boxShadow: '0 4px 32px rgba(0,0,0,0.10)' }}>
        ...
        {session && (
          <div style={{ background: '#f0fff4', border: '1px solid #a8e6b8', borderRadius: 12, padding: '16px 20px', marginBottom: 28, textAlign: 'left' }}>
            <div style={{ fontSize: 13, color: '#2a7a3a', fontWeight: 700, marginBottom: 8 }}>Bestellbestaetigung</div>
