    ...
    <div className="min-h-screen kc-legal">
      ...
      <div className="kc-legal__band py-12">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="kc-legal__band-leise mt-2 text-sm">Gemäß DSGVO / BDSG</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="kc-legal__karte p-6 space-y-8">
          ...
          <S title="1. Datenschutz auf einen Blick">
            <p className="font-medium kc-legal__text">Allgemeine Hinweise</p>
            <p>Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können.</p>
            <p className="font-medium kc-legal__text mt-3">Datenerfassung auf dieser Website</p>
          ...
          <S title="2. Hosting und Content Delivery Networks (CDN)">
            <p className="font-medium kc-legal__text">Externes Hosting</p>
            ...
            <p className="mt-3 font-medium kc-legal__text">Wir setzen folgenden Hoster ein:</p>
            <p>Mittwald CM Service GmbH &amp; Co. KG</p>
            <p>Königsberger Straße 4–6, 32339 Espelkamp</p>
            <p>Telefon: +49-5772-293-100</p>
            <p>Web: <a href="https://www.mittwald.de/datenschutz" target="_blank" rel="noopener noreferrer" className="kc-legal__link hover:underline">www.mittwald.de/datenschutz</a></p>
          ...
          <S title="3. Allgemeine Hinweise und Pflichtinformationen">
            <p className="font-medium kc-legal__text">Datenschutz</p>
            <p>Die Betreiber dieser Seiten nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Wir behandeln Ihre personenbezogenen Daten vertraulich und entsprechend der gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklärung.</p>
            <p className="mt-3 font-medium kc-legal__text">Hinweis zur verantwortlichen Stelle</p>
            <p>KOMPAGNON communications BP GmbH</p>
            <p>Marienfelder Straße 52, 56070 Koblenz</p>
            <p>Telefon: +49-261-88447-0</p>
            <p>E-Mail: <a href="mailto:info@kompagnon.eu" className="kc-legal__link hover:underline">info@kompagnon.eu</a></p>
            <p className="mt-3 font-medium kc-legal__text">Speicherdauer</p>
            ...
            <p className="mt-3 font-medium kc-legal__text">Gesetzlich vorgeschriebener Datenschutzbeauftragter</p>
            <p>defensIT UG (haftungsbeschränkt) · Hr. Björn Viohl</p>
            <p>Frankenstrasse 2, 56068 Koblenz</p>
            <p>Telefon: +49(0)261 9888 964-14</p>
            <p>E-Mail: <a href="mailto:Bjoern.Viohl@defensIT.de" className="kc-legal__link hover:underline">Bjoern.Viohl@defensIT.de</a></p>
            <p>Web: <a href="https://www.defensIT.de" target="_blank" rel="noopener noreferrer" className="kc-legal__link hover:underline">www.defensIT.de</a></p>
            <p className="mt-3 font-medium kc-legal__text">Hinweis zur Datenweitergabe in die USA</p>
            ...
            <p className="mt-3 font-medium kc-legal__text">SSL- bzw. TLS-Verschlüsselung</p>
            ...
            <p className="mt-3 font-medium kc-legal__text">Recht auf Datenübertragbarkeit</p>
            ...
            <p className="mt-3 font-medium kc-legal__text uppercase text-xs tracking-wider">Widerspruchsrecht (Art. 21 DSGVO)</p>
            ...
            <p className="mt-3 font-medium kc-legal__text">Widerspruch gegen Werbe-E-Mails</p>
          ...
          <S title="4. Datenerfassung auf dieser Website">
            <p className="font-medium kc-legal__text">Cookies</p>
            ...
            <p className="mt-3 font-medium kc-legal__text">Server-Log-Dateien</p>
            ...
            <p className="mt-3 font-medium kc-legal__text">Kontaktformular</p>
            ...
            <p className="mt-3 font-medium kc-legal__text">Anfrage per E-Mail, Telefon oder Telefax</p>
          ...
          <S title="5. Analyse-Tools und Werbung">
            <p className="font-medium kc-legal__text">Google Analytics</p>
            ...
            <p className="mt-2">Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details: <a href="https://privacy.google.com/businesses/controllerterms/mccs/" target="_blank" rel="noopener noreferrer" className="kc-legal__link hover:underline">privacy.google.com/businesses/controllerterms/mccs/</a></p>
            <p className="mt-2 font-medium kc-legal__text">IP-Anonymisierung</p>
            ...
            <p className="mt-2 font-medium kc-legal__text">Browser Plugin</p>
            <p>Sie können die Erfassung Ihrer Daten durch Google verhindern durch Download des Browser-Plugins unter: <a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" rel="noopener noreferrer" className="kc-legal__link hover:underline">tools.google.com/dlpage/gaoptout</a></p>
            <p className="mt-2">Mehr Informationen: <a href="https://support.google.com/analytics/answer/6004245?hl=de" target="_blank" rel="noopener noreferrer" className="kc-legal__link hover:underline">support.google.com/analytics/answer/6004245</a></p>
            <p className="mt-2 font-medium kc-legal__text">Speicherdauer</p>
            <p>Bei Google gespeicherte Daten auf Nutzer- und Ereignisebene werden nach 14 Monaten anonymisiert bzw. gelöscht. Details: <a href="https://support.google.com/analytics/answer/7667196?hl=de" target="_blank" rel="noopener noreferrer" className="kc-legal__link hover:underline">support.google.com/analytics/answer/7667196</a></p>
          </S>

          <S title="6. Plugins und Tools">
            <p className="font-medium kc-legal__text">Google Web Fonts</p>
            ...
            <p className="mt-2">Weitere Informationen: <a href="https://developers.google.com/fonts/faq" target="_blank" rel="noopener noreferrer" className="kc-legal__link hover:underline">developers.google.com/fonts/faq</a></p>
            <p className="mt-3 font-medium kc-legal__text">Google Maps</p>
            ...
            <p className="mt-2">Mehr Informationen: <a href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener noreferrer" className="kc-legal__link hover:underline">policies.google.com/privacy</a></p>
          </S>

          <S title="7. Eigene Dienste">
            <p className="font-medium kc-legal__text">Umgang mit Bewerberdaten</p>
            ...
            <p className="mt-3 font-medium kc-legal__text">Leadinfo</p>
            ...
            <p className="mt-2">Weitere Informationen und Opt-out: <a href="https://www.leadinfo.com/en/opt-out" target="_blank" rel="noopener noreferrer" className="kc-legal__link hover:underline">www.leadinfo.com/en/opt-out</a></p>
          </S>
