...
export default function KampagneLandingPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (!domain.trim() || !email.trim() || !mobil.trim()) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Header */}
      <div style={{ background: PRIMARY, padding: '16px 24px', display: 'flex', alignItems: 'center' }}>
        <span style={{
          color: '#fff',
          fontWeight: 800,
          fontSize: 22,
            ...
            {[
              ...
              <li key={item} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 15, color: '#333' }}>
                <span style={{
                  ...
                  flexShrink: 0, fontSize: 14, color: PRIMARY, fontWeight: 700,
                }}>✓</span>
                {item}
              </li>
            ))}
