...
export default function PackageStarter() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f4f6f8', fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #004d5e 0%, #006880 100%)', padding: 'clamp(40px, 8vw, 80px) 20px clamp(60px, 10vw, 100px)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'relative', maxWidth: 640, margin: '0 auto' }}>
          ...
          <div className="fade4" style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'center', gap: 8 }}>
            <span style={{ fontSize: 'clamp(36px, 10vw, 52px)', fontWeight: 700, color: '#b3e0ea', letterSpacing: '-0.03em' }}>1.500 €</span>
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '0 20px 80px', marginTop: -40 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 20, alignItems: 'flex-start' }}>
          <div style={{ background: 'white', borderRadius: 20, padding: 32, boxShadow: '0 8px 40px rgba(0,142,170,0.12)', border: '2px solid #008eaa' }}>
            ...
            <div style={{ fontSize: 18, fontWeight: 700, color: '#0f1c20', marginBottom: 4 }}>Starter — 1.500 € netto</div>
