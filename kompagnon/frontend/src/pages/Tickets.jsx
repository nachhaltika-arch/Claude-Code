...
const TC = { bug: { label: 'Fehler', icon: '🐛', color: '#dc2626', bg: 'var(--status-danger-bg)' }, feature: { label: 'Idee', icon: '💡', color: '#7c3aed', bg: 'var(--status-neutral-bg)' }, feedback: { label: 'Feedback', icon: '💬', color: 'var(--brand-primary)', bg: 'var(--bg-hover)' }, question: { label: 'Frage', icon: '❓', color: 'var(--warn)', bg: 'var(--status-warning-bg)' } };
const SC = { open: { label: 'Offen', icon: '🔵', color: '#2563eb', bg: 'var(--status-info-bg)' }, in_progress: { label: 'In Bearbeitung', icon: '🟡', color: 'var(--warn)', bg: 'var(--status-warning-bg)' }, resolved: { label: 'Geloest', icon: '🟢', color: 'var(--success)', bg: 'var(--status-success-bg)' }, closed: { label: 'Geschlossen', icon: '⚫', color: 'var(--text-tertiary)', bg: 'var(--status-neutral-bg)' } };
const PC = { low: { label: 'Niedrig', color: 'var(--text-tertiary)', bg: 'var(--status-neutral-bg)' }, medium: { label: 'Mittel', color: 'var(--warn)', bg: 'var(--status-warning-bg)' }, high: { label: 'Hoch', color: '#dc2626', bg: 'var(--status-danger-bg)' }, critical: { label: 'Kritisch', color: '#7c3aed', bg: 'var(--status-neutral-bg)' } };
        ...
        {selected && (
          <div style={{ background: 'var(--bg-surface)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border-light)', overflow: 'hidden', position: isMobile ? 'fixed' : 'sticky', top: isMobile ? 0 : 20, left: isMobile ? 0 : 'auto', right: isMobile ? 0 : 'auto', bottom: isMobile ? 0 : 'auto', zIndex: isMobile ? 200 : 1, maxHeight: isMobile ? '100vh' : 'auto', overflowY: 'auto', minWidth: 0 }}>
            ...
            <div style={{ padding: 18 }}>
              ...
              <div style={{ fontSize: 16, fontWeight: 800, color: 'var(--text-primary)', marginBottom: 8 }}>{selected.title}</div>
              <div style={{ fontSize: 12, color: 'var(--text-tertiary)', marginBottom: 14, display: 'flex', flexDirection: 'column', gap: 4 }}>
