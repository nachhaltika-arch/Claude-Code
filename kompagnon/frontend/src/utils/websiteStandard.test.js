import { stufeKurz, stufeFuerScore, stufeAnzeige } from './websiteStandard';
...
describe('stufeFuerScore', () => {
  test.each([
    ...
    [94,  'Website Standard Gold'],
    [85,  'Website Standard Gold'],
    [84,  'Website Standard Silber'],
    [72,  'Website Standard Silber'],
    [70,  'Website Standard Silber'],
    [69,  'Website Standard Bronze'],
  ...
  test('die alten Schwellen gelten nicht mehr', () => {
    ...
    expect(stufeFuerScore(72)).toBe('Website Standard Silber');
    // 86 hiess im Widget frueher „Platin".
    expect(stufeFuerScore(86)).toBe('Website Standard Gold');
  });
...
describe('stufeAnzeige', () => {
  ...
  test('ohne Angabe vom Server wird gerechnet', () => {
    expect(stufeAnzeige(72)).toBe('Website Standard Silber 🥈');
  });
...
describe('stufeKurz', () => {
  test('lässt „Website Standard" weg', () => {
  ...
  test('die Stufe vom Server gilt auch hier', () => {
    ...
    expect(stufeKurz(96, 'Website Standard Bronze')).toBe('Bronze');
  });
});
